...
<nav class="navbar sticky-top navbar-light justify-content-between p-2 bg-dark">
    <div class="d-flex flex-row justify-content-around">
        ...
        <ul class="nav nav-tabs mt-2">
            <li role="presentation" class="active mr-2 ml-2 border-right p-1"><a href="<?php echo "{$BASE_URL}" ?>">Home</a></li>
            <li role="presentation" class="mr-2 border-right p-1"><a href="./pages/profile.php">Profile</a></li>
            <li role="presentation" class="p-1"><a href="#">Projects</a></li>
        </ul>
    </div>
    <div>
    ...
    <div class="d-flex flex-column justify-content-around">
        <div class="d-flex flex-row">
            ...
            <div class="dropdown drop">
                <button class="btn text-dark text-bold dropdown-toggle" style="background-color:whitesmoke" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Pottodaa
                </button>
                <div class="dropdown-menu" style="color:whitesmoke" aria-labelledby="dropdownMenuButton">
    ...
    <div class="row p-4">
        <div class="col-md-12 col-12 m-auto d-flex flex-row justify-content-between">
            <div class="col-md-2 d-flex flex-column justify-content-top shadow p-4 w-100">
                ...
                <div class="w-100  text-center border-bottom  d-flex flex-row justify-content-between mb-1">
                    <p class="h5 text-primary">Working Hours</p>
                    <a href="./pages/workinghours.php"><button class="btn border-0"><i class="bi bi-caret-right"></i></button></a>
                </div>
                <div class="w-100  text-center  border-bottom d-flex flex-row justify-content-between mb-1">
                    <p class="h5 text-primary">Hours Worked</p>
                    <a href="./pages/hoursworked.php"><button class="btn border-0"><i class="bi bi-caret-right"></i></button></a>
                </div>
                <div class="w-100  text-center border-bottom  d-flex flex-row justify-content-between mb-1">
                    <p class="h5 text-primary">My leaves</p>
                    <a href="./pages/leaves.php"><button class="btn border-0"><i class="bi bi-caret-right"></i></button></a>
                </div>
                ...
                <div class="m-auto col-md-10 d-flex flex-row justify-content-between p-2 mb-3">
                    <div class="col-md-5 d-flex flex-column justify-content-around text-left shadow p-3 border rounded">
                        ...
                        <div class="d-flex flex-row justify-content-between text-left">
                            <div>
                                <p class="h6  text-dark"><span class="text-success"><i class="bi bi-dot"></i></span> Bala Subrahmanyam</p>
                                <p class="ml-4">Full stack developer</p>
                            </div>
                            <img src="./images/balu.jpeg" width="40" height="40" class="border rounded">
                        </div>
                        <div class="d-flex flex-row justify-content-between text-left">
                            <div>
                                <p class="h6  text-dark"><span class="text-success"><i class="bi bi-dot"></i></span> Bala Subrahmanyam</p>
                    ...
                    <div class="col-md-5 d-flex flex-column justify-content-around text-left shadow p-3 border rounded">
                        ...
                        <div class="d-flex flex-row justify-content-between text-left">
                            <div>
                                <p class="h6  text-dark"><span class="text-dark"><i class="bi bi-dot"></i></span> Bala Subrahmanyam</p>
                                <p class="ml-4">Full stack developer</p>
                            </div>
                            <img src="./images/balu.jpeg" width="40" height="40" class="border rounded">
                        </div>
